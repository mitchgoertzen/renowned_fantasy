...
List<int> calculateMatchupScores(
    Map<String, dynamic> statsOne, Map<String, dynamic> statsTwo) {
  int scoreOne = 0;
  int scoreTwo = 0;

  statsOne.forEach((k, v) => {
        if (v > statsTwo[k]) {scoreOne++} else if (v < statsTwo[k]) {scoreTwo++}
      });

  return [scoreOne, scoreTwo];
}

String playerInfoStringBuilder(String player) {
  String info = '';
